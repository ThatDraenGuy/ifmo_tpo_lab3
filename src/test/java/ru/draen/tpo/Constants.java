...
public class Constants {
    public static final String WRONG_EMAIL = "aboba";
    public static final String NEW_EMAIL = "ndm42513@vogco.com";
    public static final String EXISTING_EMAIL = "pbt20581@fosiq.com";
